...
class GEOFile(SSFile):
    ...
    def read_input_to_pandas(self, columnList=[], indexCol="Sample"):
        ...
        if self.isGzipped:
            ...
            df = self.read_geo(tempFile.name)
            #delete the tempfile
    ...
    def read_geo(self,fileName): 
        ...
        df = pd.read_csv(filepath_or_buffer=fileName, sep="\t", header=None, index_col=0, skiprows=range(0, begin), nrows=end)
